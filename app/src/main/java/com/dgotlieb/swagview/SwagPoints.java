...
public class SwagPoints extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int arcColor = ContextCompat.getColor(context, android.R.color.holo_blue_bright);
        int progressColor = ContextCompat.getColor(context, android.R.color.holo_orange_dark);
        int textColor = ContextCompat.getColor(context, android.R.color.holo_red_light);
        mProgressWidth = (int) (mProgressWidth * density);
        mArcWidth = (int) (mArcWidth * density);
        mTextSize = (int) (mTextSize * density);

        mIndicatorIcon = ContextCompat.getDrawable(context, R.drawable.play);
